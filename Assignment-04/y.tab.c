...
{
       0,   207,   207,   207,   214,   214,   221,   221,   231,   232,
     235,   235,   237,   239,   245,   251,   260,   261,   262,   263,
     267,   268,   269,   275,   283,   291,   308,   325,   331,   340,
     340,   353,   353,   369,   370,   371,   374,   375,   378,   378,
     386,   386,   396,   396,   408,   408,   423,   424,   425,   431,
     439,   447,   459,   459,   464,   464,   469,   475,   484,   485,
     489,   490,   491,   492,   493,   494,   495,   504,   504,   506,
     515,   517,   519,   528,   533,   538,   544,   550,   559,   564,
     566,   568,   573,   579,   588,   590,   592,   598,   607,   609,
     611,   618,   627,   629,   635,   642,   649,   656,   663,   670,
     676,   684,   686,   697,   703,   709,   717,   719,   726,   728,
     735,   737,   744,   746,   753,   755,   762,   764,   769,   776,
     778,   783,   788,   793,   800,   802,   807,   814,   816,   821,
     828,   830,   835,   840,   847,   849,   857,   865,   877,   878,
     879,   880,   883,   885,   899,   906,   913,   919,   925,   932,
     939,   947,   957,   958,   959,   965,   973,   990,   995,  1000,
    1006,  1010,  1018
};
#endif
...
#line 2423 "y.tab.c"
  ...
  case 88: /* expression: assignment_expr  */
#line 608 "parse.y"
           { (yyval.expr_info) = (yyvsp[0].expr_info); }
#line 2429 "y.tab.c"
    break;

  case 89: /* expression: expression COMMA_TOK assignment_expr  */
#line 610 "parse.y"
...
#line 2457 "y.tab.c"
  ...
  case 92: /* assignment_expr: ternary_expr  */
#line 628 "parse.y"
                { (yyval.expr_info) = (yyvsp[0].expr_info); }
#line 2463 "y.tab.c"
    break;

  case 93: /* assignment_expr: unary_expr ASSIGN_TOK assignment_expr  */
#line 630 "parse.y"
                {
...
#line 2473 "y.tab.c"
  ...
  case 94: /* assignment_expr: unary_expr ADD_ASSIGN_TOK assignment_expr  */
#line 636 "parse.y"
                {
                  check_assignment_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, (yyvsp[-2].expr_info).is_lvalue);
...
#line 2484 "y.tab.c"
  ...
  case 95: /* assignment_expr: unary_expr SUB_ASSIGN_TOK assignment_expr  */
#line 643 "parse.y"
                {
                  check_assignment_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, (yyvsp[-2].expr_info).is_lvalue);
                  check_binary_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, "-");
...
#line 2495 "y.tab.c"
  ...
  case 96: /* assignment_expr: unary_expr MUL_ASSIGN_TOK assignment_expr  */
#line 650 "parse.y"
                {
                  check_assignment_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, (yyvsp[-2].expr_info).is_lvalue);
                  check_binary_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, "*");
...
#line 2506 "y.tab.c"
  ...
  case 97: /* assignment_expr: unary_expr DIV_ASSIGN_TOK assignment_expr  */
#line 657 "parse.y"
                {
                  check_assignment_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, (yyvsp[-2].expr_info).is_lvalue);
                  check_binary_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, "/");
...
#line 2517 "y.tab.c"
  ...
  case 98: /* assignment_expr: unary_expr MOD_ASSIGN_TOK assignment_expr  */
#line 664 "parse.y"
                {
                  check_assignment_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, (yyvsp[-2].expr_info).is_lvalue);
                  check_binary_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, "%");
...
#line 2548 "y.tab.c"
  ...
  case 101: /* ternary_expr: logical_or_expr  */
#line 685 "parse.y"
             { (yyval.expr_info) = (yyvsp[0].expr_info); }
#line 2554 "y.tab.c"
    break;

  case 102: /* ternary_expr: logical_or_expr TERNARY_TOK expression COLON_TOK ternary_expr  */
#line 687 "parse.y"
             {
...
#line 2599 "y.tab.c"
  ...
  case 106: /* logical_or_expr: logical_and_expr  */
#line 718 "parse.y"
                { (yyval.expr_info) = (yyvsp[0].expr_info); }
#line 2605 "y.tab.c"
    break;

  case 107: /* logical_or_expr: logical_or_expr OR_TOK logical_and_expr  */
#line 720 "parse.y"
                {
...
#line 2614 "y.tab.c"
  ...
  case 108: /* logical_and_expr: bit_or_expr  */
#line 727 "parse.y"
                 { (yyval.expr_info) = (yyvsp[0].expr_info); }
#line 2620 "y.tab.c"
    break;

  case 109: /* logical_and_expr: logical_and_expr AND_TOK bit_or_expr  */
#line 729 "parse.y"
                 {
                   (yyval.expr_info).type = check_logical_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, "&&");
                   (yyval.expr_info).is_lvalue = 0;
...
#line 2629 "y.tab.c"
  ...
  case 110: /* bit_or_expr: bit_xor_expr  */
#line 736 "parse.y"
            { (yyval.expr_info) = (yyvsp[0].expr_info); }
#line 2635 "y.tab.c"
    break;

  case 111: /* bit_or_expr: bit_or_expr BIT_OR_TOK bit_xor_expr  */
#line 738 "parse.y"
            {
...
#line 2644 "y.tab.c"
  ...
  case 112: /* bit_xor_expr: bit_and_expr  */
#line 745 "parse.y"
             { (yyval.expr_info) = (yyvsp[0].expr_info); }
#line 2650 "y.tab.c"
    break;

  case 113: /* bit_xor_expr: bit_xor_expr BIT_XOR_TOK bit_and_expr  */
#line 747 "parse.y"
             {
               (yyval.expr_info).type = check_binary_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, "^");
               (yyval.expr_info).is_lvalue = 0;
...
#line 2659 "y.tab.c"
  ...
  case 114: /* bit_and_expr: equality_expr  */
#line 754 "parse.y"
             { (yyval.expr_info) = (yyvsp[0].expr_info); }
#line 2665 "y.tab.c"
    break;

  case 115: /* bit_and_expr: bit_and_expr BIT_AND_TOK equality_expr  */
#line 756 "parse.y"
             {
               (yyval.expr_info).type = check_binary_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, "&");
               (yyval.expr_info).is_lvalue = 0;
...
#line 2674 "y.tab.c"
  ...
  case 116: /* equality_expr: relational_expr  */
#line 763 "parse.y"
              { (yyval.expr_info) = (yyvsp[0].expr_info); }
#line 2680 "y.tab.c"
    break;

  case 117: /* equality_expr: equality_expr EQ_TOK relational_expr  */
#line 765 "parse.y"
              {
...
#line 2689 "y.tab.c"
  ...
  case 118: /* equality_expr: equality_expr NEQ_TOK relational_expr  */
#line 770 "parse.y"
              {
                (yyval.expr_info).type = check_relational_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, "!=");
                (yyval.expr_info).is_lvalue = 0;
...
#line 2698 "y.tab.c"
  ...
  case 119: /* relational_expr: shift_expr  */
#line 777 "parse.y"
                { (yyval.expr_info) = (yyvsp[0].expr_info); }
#line 2704 "y.tab.c"
    break;

  case 120: /* relational_expr: relational_expr LT_TOK shift_expr  */
#line 779 "parse.y"
                {
                  (yyval.expr_info).type = check_relational_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, "<");
                  (yyval.expr_info).is_lvalue = 0;
...
#line 2713 "y.tab.c"
  ...
  case 121: /* relational_expr: relational_expr GT_TOK shift_expr  */
#line 784 "parse.y"
                {
                  (yyval.expr_info).type = check_relational_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, ">");
                  (yyval.expr_info).is_lvalue = 0;
...
#line 2722 "y.tab.c"
  ...
  case 122: /* relational_expr: relational_expr LE_TOK shift_expr  */
#line 789 "parse.y"
                {
                  (yyval.expr_info).type = check_relational_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, "<=");
                  (yyval.expr_info).is_lvalue = 0;
...
#line 2731 "y.tab.c"
  ...
  case 123: /* relational_expr: relational_expr GE_TOK shift_expr  */
#line 794 "parse.y"
                {
                  (yyval.expr_info).type = check_relational_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, ">=");
                  (yyval.expr_info).is_lvalue = 0;
...
#line 2740 "y.tab.c"
  ...
  case 124: /* shift_expr: additive_expr  */
#line 801 "parse.y"
           { (yyval.expr_info) = (yyvsp[0].expr_info); }
#line 2746 "y.tab.c"
    break;

  case 125: /* shift_expr: shift_expr BIT_LSHIFT_TOK additive_expr  */
#line 803 "parse.y"
           {
             (yyval.expr_info).type = check_binary_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, "<<");
             (yyval.expr_info).is_lvalue = 0;
...
#line 2755 "y.tab.c"
  ...
  case 126: /* shift_expr: shift_expr BIT_RSHIFT_TOK additive_expr  */
#line 808 "parse.y"
           {
             (yyval.expr_info).type = check_binary_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, ">>");
             (yyval.expr_info).is_lvalue = 0;
...
#line 2764 "y.tab.c"
  ...
  case 127: /* additive_expr: multiplicative_expr  */
#line 815 "parse.y"
              { (yyval.expr_info) = (yyvsp[0].expr_info); }
#line 2770 "y.tab.c"
    break;

  case 128: /* additive_expr: additive_expr ADD_TOK multiplicative_expr  */
#line 817 "parse.y"
              {
                (yyval.expr_info).type = check_binary_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, "+");
                (yyval.expr_info).is_lvalue = 0;
...
#line 2779 "y.tab.c"
  ...
  case 129: /* additive_expr: additive_expr SUB_TOK multiplicative_expr  */
#line 822 "parse.y"
              {
                (yyval.expr_info).type = check_binary_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, "-");
                (yyval.expr_info).is_lvalue = 0;
...
#line 2788 "y.tab.c"
  ...
  case 130: /* multiplicative_expr: unary_expr  */
#line 829 "parse.y"
                    { (yyval.expr_info) = (yyvsp[0].expr_info); }
#line 2794 "y.tab.c"
    break;

  case 131: /* multiplicative_expr: multiplicative_expr MUL_TOK unary_expr  */
#line 831 "parse.y"
                    {
                      (yyval.expr_info).type = check_binary_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, "*");
                      (yyval.expr_info).is_lvalue = 0;
...
#line 2803 "y.tab.c"
  ...
  case 132: /* multiplicative_expr: multiplicative_expr DIV_TOK unary_expr  */
#line 836 "parse.y"
                    {
                      (yyval.expr_info).type = check_binary_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, "/");
                      (yyval.expr_info).is_lvalue = 0;
...
#line 2812 "y.tab.c"
  ...
  case 133: /* multiplicative_expr: multiplicative_expr MOD_TOK unary_expr  */
#line 841 "parse.y"
                    {
                      (yyval.expr_info).type = check_binary_op_type((yyvsp[-2].expr_info).type, (yyvsp[0].expr_info).type, "%");
                      (yyval.expr_info).is_lvalue = 0;
...
#line 2827 "y.tab.c"
  ...
  case 135: /* unary_expr: INC_TOK unary_expr  */
#line 850 "parse.y"
           {
...
#line 2839 "y.tab.c"
  ...
  case 136: /* unary_expr: DEC_TOK unary_expr  */
#line 858 "parse.y"
           {
             if (!(yyvsp[0].expr_info).is_lvalue) {
...
#line 2851 "y.tab.c"
  ...
  case 137: /* unary_expr: unary_operator unary_expr  */
#line 866 "parse.y"
           {
...
#line 2865 "y.tab.c"
  ...
  case 142: /* postfix_expr: primary_expr  */
#line 884 "parse.y"
             { (yyval.expr_info) = (yyvsp[0].expr_info); }
#line 2871 "y.tab.c"
    break;

  case 143: /* postfix_expr: postfix_expr LBRACKET_TOK expression RBRACKET_TOK  */
#line 886 "parse.y"
             {
               // Array subscripting
...
#line 2953 "y.tab.c"
  ...
  case 150: /* postfix_expr: postfix_expr INC_TOK  */
#line 940 "parse.y"
             {
...
#line 2965 "y.tab.c"
  ...
  case 151: /* postfix_expr: postfix_expr DEC_TOK  */
#line 948 "parse.y"
             {
               if (!(yyvsp[-1].expr_info).is_lvalue) {
                 print_type_error("Decrement operator requires an lvalue");
...
#line 3018 "y.tab.c"
  ...
  case 157: /* primary_expr: INTCONST_TOK  */
#line 991 "parse.y"
             {
...
#line 3027 "y.tab.c"
  ...
  case 158: /* primary_expr: FLOATCONST_TOK  */
#line 996 "parse.y"
             {
...
#line 3046 "y.tab.c"
  ...
  case 160: /* primary_expr: LPAREN_TOK expression RPAREN_TOK  */
#line 1007 "parse.y"
             {
